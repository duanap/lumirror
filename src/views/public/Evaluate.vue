    ...
    <article v-else-if="task" class="score-card">
      ...
      <section class="rule-card" aria-label="本次计分方式">
        <div class="rule-title">
          <strong>本次计分方式</strong>
          <small>仅用于本次匿名评分</small>
        </div>
        <p>{{formula}}</p>
