  ...
  <div class="home-page">
    ...
    <footer>
      <div class="section-wrap footer-inner">
        <div class="brand footer-brand"><img class="brand-mark" src="/favicon.svg" alt="" /><span class="brand-name">和光镜鉴</span><span class="brand-en">Lumirror</span></div>
        <p>匿名反馈 · 公平成长</p>
