          ...
          <el-form-item class="avatar-field" label="头像">
            <div class="avatar-picker">
              ...
              <div class="avatar-options">
                <button type="button" class="avatar-option" :class="{selected:!form.avatar}" @click="form.avatar=''">
                  <EmployeeAvatar :gender="form.gender" :size="64" alt="系统默认头像"/>
                  <small>系统默认</small>
                </button>
