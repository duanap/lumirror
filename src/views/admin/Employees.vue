...
<style scoped>
.filter-panel{display:grid;grid-template-columns:minmax(200px,1.4fr) repeat(3,minmax(140px,1fr)) auto auto auto;gap:10px;margin:20px 0 16px;padding:14px}.batch-bar{display:flex;align-items:center;gap:10px;margin:0 0 16px;padding:10px 14px}.batch-bar span{margin-right:auto;color:var(--muted)}.batch-bar b{color:var(--brand)}.person{display:flex;align-items:center;gap:10px}.person img{width:42px;height:42px;border-radius:50%;background:#fff2e9}.person small{display:block;margin-top:4px;color:#999}.form-grid{display:grid;grid-template-columns:1fr 1fr;gap:0 18px}@media(max-width:1180px){.filter-panel{grid-template-columns:repeat(2,1fr)}}@media(max-width:600px){.filter-panel,.form-grid{grid-template-columns:1fr}.filter-panel{padding:12px}.batch-bar{align-items:stretch;flex-direction:column}}
</style>
