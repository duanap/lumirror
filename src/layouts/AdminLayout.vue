...
<style scoped>
.admin-shell{display:grid;grid-template-columns:264px minmax(0,1fr);min-height:100vh;background:linear-gradient(135deg,#f6f2ed,#f7f5f1 45%,#f3eee8);transition:grid-template-columns .2s ease}.admin-shell.collapsed{grid-template-columns:82px minmax(0,1fr)}aside{position:sticky;top:0;z-index:20;height:100vh;overflow:auto;border-right:1px solid var(--line);background:rgba(255,255,255,.94);backdrop-filter:blur(14px)}.brand{display:flex;align-items:center;gap:12px;height:74px;padding:0 20px;border-bottom:1px solid var(--line);color:var(--brand)}.brand-mark{display:grid;place-items:center;flex:0 0 auto;width:36px;height:36px;border-radius:10px;color:#fff;background:linear-gradient(135deg,var(--brand),var(--brand-2));font-weight:800}.brand-copy{display:grid;line-height:1.15}.brand-copy strong{color:var(--ink);font-size:17px}.brand-copy small{margin-top:3px;color:var(--muted);font-size:11px}nav{padding:12px 10px 22px}.nav-group{padding:8px 0}.nav-parent{display:flex;align-items:center;gap:10px;height:32px;padding:0 12px;color:var(--subtle);font-size:12px;font-weight:760;white-space:nowrap}.nav-parent svg{width:15px;height:15px}.nav-group a{display:flex;align-items:center;gap:12px;height:42px;margin:2px 0;padding:0 13px;border-radius:10px;color:#4b433e;white-space:nowrap;transition:background .15s,color .15s,transform .15s}.nav-group a svg{width:18px;height:18px}.nav-group a:hover{color:var(--brand);background:#fff7f1}.router-link-active{color:var(--brand)!important;background:#fff0e8;box-shadow:inset 3px 0 0 var(--brand)}.collapsed nav span,.collapsed .brand-copy{display:none}.collapsed .brand{justify-content:center;padding:0}.collapsed .nav-group a,.collapsed .nav-parent{justify-content:center;padding:0}.admin-main{min-width:0}header{position:sticky;top:0;z-index:10;display:flex;align-items:center;height:74px;padding:0 30px;border-bottom:1px solid rgba(226,215,207,.72);background:rgba(255,255,255,.86);backdrop-filter:blur(14px)}.collapse{display:grid;place-items:center;width:38px;height:38px;margin-right:18px;border:1px solid var(--line);border-radius:10px;background:#fff;cursor:pointer}.collapse:hover{color:var(--brand);box-shadow:var(--focus)}.collapse svg{width:19px;height:19px}.breadcrumb{color:#5d554f;font-size:14px;font-weight:650}.user-menu{display:flex;margin-left:auto}.admin-user{display:flex;align-items:center;gap:10px;cursor:pointer}.admin-user>svg{width:14px;height:14px}.avatar{display:grid;place-items:center;width:34px;height:34px;border-radius:50%;color:#fff;background:#2f2925;font-weight:760}.user-copy{display:grid;text-align:right}.user-copy b{color:var(--ink);font-size:14px}.user-copy small{margin-top:2px;color:var(--muted);font-size:11px}main{width:min(100%,var(--content-max));margin:0 auto;padding:28px 34px 44px}.mobile-toggle,.mobile-close,.mobile-mask{display:none}
@media(max-width:960px){.admin-shell,.admin-shell.collapsed{display:block}.admin-shell aside{position:fixed;left:0;top:0;width:286px;transform:translateX(-102%);box-shadow:0 20px 60px rgba(29,22,18,.2);transition:transform .22s ease}.admin-shell.mobile-open aside{transform:translateX(0)}.admin-shell aside span{display:inline}.admin-shell .nav-group a,.admin-shell .nav-parent{justify-content:flex-start;padding:0 14px}.mobile-mask{position:fixed;inset:0;z-index:15;background:rgba(35,25,20,.34)}.mobile-open .mobile-mask{display:block}.desktop-toggle{display:none}.mobile-toggle,.mobile-close{display:grid}.mobile-close{place-items:center;width:34px;height:34px;margin-left:auto;border:1px solid var(--line);border-radius:10px;color:var(--brand);background:#fff}.mobile-close svg{width:18px}.breadcrumb{display:none}header{height:66px;padding:0 16px}.user-copy small{display:none}main{padding:20px 14px 36px}}
</style>
